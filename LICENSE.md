...
3. 禁止在本项目的派生产品中使用 Zhihu-deco 的名字和 Logo；
4. 如果再发布的产品中包含使用 Zhihu-deco 源代码或直接引用 Zhihu-deco 的作品，请在显著位置，注明 Zhihu-deco 的版权信息；
5. 您被授权分发修改后的编译版本（即您的派生产品），即使您可能移除了 Zhihu-deco 付费墙。如果您进行了任何可能影响本项目付费墙的结果，您必须合理提醒用户以使他们知情，并附上本项目付费入口；
6. 在您的衍生作品中，若有使用 Zhihu-deco 的源代码，必须使用本协议进行授权；
...
11. 如果您使用了 Zhihu-deco 的源代码或直接引用 Zhihu-deco 的作品，将视为您已接受此协议。
